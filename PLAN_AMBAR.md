...
- **Fase 7: EN PROGRESO** (arrancada 2026-07-29). Validado en vivo por Raúl, pantalla por pantalla: base de tokens + router, `AuthScreen`, `HomeScreen` (shell completo) y `ChatScreen`. Ver "Decisiones técnicas — Fase 7" para el detalle. Falta: `SettingsScreen`, `LiveScreen`, la vista Memoria real (hoy es un stub) y la vista Historial (todavía no existe).
