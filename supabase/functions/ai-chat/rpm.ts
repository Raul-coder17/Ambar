...
// Lógica pura (sin I/O), igual patrón que Organizador-IA. El caller
// (index.ts) es quien lee las marcas de ia_llamadas_log, llama a esto para
// decidir, y si `allowed` inserta la marca nueva.
